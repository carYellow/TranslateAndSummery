...
async def create_summary_completion_async(prompt: str, max_tokens: int = 300, temperature: float = 0.7):
    """
    Asynchronous version of create_summary_completion function.
    """
    loop = asyncio.get_event_loop()
...
async def summarize(request: Request):
    """
    Endpoint for streaming summary generation and translation to Hebrew.
...
if __name__ == "__main__":
    ...
    uvicorn.run("Part 3:app", host="0.0.0.0", port=8000, log_level="debug", reload=True)